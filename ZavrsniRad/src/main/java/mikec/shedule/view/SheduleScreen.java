...
public class SheduleScreen {
    ...
    public SheduleScreen(String year, String month) throws BaseException {
        table = new JTable();
        frame = new JFrame();
    ...
    private void addRows() throws BaseException {
        ...
        table.getColumnModel().getColumn(0).setCellEditor(new DefaultCellEditor(t));
